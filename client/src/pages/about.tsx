    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-muted-foreground leading-loose text-lg">
            QalamAI هي منصّة متكاملة للكتابة الأدبية العربية بالذكاء الاصطناعي. تجمع بين تقنيات الذكاء الاصطناعي المتقدّمة وفهم عميق للأدب العربي لتقديم تجربة كتابة فريدة من نوعها. من خلال شخصية أبو هاشم، تساعد المنصّة الكتّاب على بناء شخصياتهم وتطوير حبكاتهم وكتابة فصول رواياتهم بأسلوب أدبي رفيع.
          </p>
          <p className="text-muted-foreground leading-loose text-lg">
            سواء كنت كاتباً مبتدئاً تخطو خطواتك الأولى في عالم الرواية، أو كاتباً محترفاً تبحث عن أداة تساعدك في تطوير أفكارك، فإن QalamAI مصمّمة لتكون شريكك الإبداعي في كل مرحلة من مراحل الكتابة.
          </p>
        </div>
      </section>
          ...
          <Card className="bg-background">
            <CardContent className="p-8 space-y-4">
              ...
              <p className="font-serif text-lg leading-loose text-foreground" data-testid="text-mission">
                تمكين الكتّاب العرب من تحويل أفكارهم إلى روايات مكتوبة بلغة عربية فصيحة، عبر ذكاء اصطناعي يحترم القيم ويصون جمال اللغة.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-background">
