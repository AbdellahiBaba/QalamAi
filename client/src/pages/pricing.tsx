...
const mainPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      "مذكرات تخرج أكاديمية — جميع التخصصات",
...
const faqItems = [
  {
    ...
    a: "خطة المقالات مخصصة لكتابة المقالات والتقارير الصحفية. خطة السيناريوهات لكتابة سيناريوهات الأفلام والمسلسلات. الخطة الشاملة تمنحك وصولاً كاملاً لجميع أنواع الكتابة بما فيها الروايات والقصص القصيرة والخواطر ومحتوى السوشيال ميديا ومذكرات التخرج الأكاديمية.",
  },
  {
